# AI/AGI Overview — Presentation Synthesis Report (FINAL)

> **Note (2026-09-04, post-finalization revision):** after this report was
> finalized, the deck went through a tone and structure pivot: reordered
> around "what AI is → what AGI is → how to use it → popular models →
> parameters/MoE/benchmarks for model selection → responsible AI →
> business lens → close," with the Gartner Hype Cycle moved to a short
> bonus section for executive conversations, and a second business-lens
> slide added (Woods's "Four Pillars" framework). The audience is software
